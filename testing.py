...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/SHANTO-KING/Approval/blob/main/Approval.txt').text
        ua=open('bbnew.txt','w')
